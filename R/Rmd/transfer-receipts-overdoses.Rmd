...
ggplot(df, aes(x = PercentTotalIncome, y = Rate, size = Population)) +
  geom_point() +
  theme_classic() +
  labs(x = "Yearly Opioid Overdose Deaths per 100,000 People",
       y = "Government Transfers as Percent of Total Income",
       size = "County Population") +
  ggtitle("The Relationship Between Government Transfers and Opioid Overdoses")
```
